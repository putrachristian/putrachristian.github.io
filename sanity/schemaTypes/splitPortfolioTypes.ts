...
export const speakingEntryType = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      type: 'image',
      options: { hotspot: true },
      description: 'Upload the talk poster here. This is used before Poster fallback URL.',
    }),
    defineField({
      name: 'posterUrl',
      title: 'Poster fallback URL',
      type: 'string',
      description: 'Use a public URL or /public path. Uploaded poster is used first.',
    }),
